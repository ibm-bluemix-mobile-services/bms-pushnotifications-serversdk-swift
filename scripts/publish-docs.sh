...
docs_directory='./ibm-bluemix-mobile-services.github.io/API-docs/server-SDK/IBMPushNotifications'
...
cd ibm-bluemix-mobile-services.github.io
git add .
git commit -m "Published docs for Push Swift server SDK version ${version}"
git rebase master
